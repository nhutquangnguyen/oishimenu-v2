        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Dữ liệu mẫu</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-sm font-medium text-gray-600">Tỷ lệ hủy đơn</h3>
                    <Info className="h-4 w-4 text-gray-400" />
                  </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <h4 className="text-sm font-medium text-gray-600">Hôm nay</h4>
                    <Info className="h-4 w-4 text-gray-400" />
                  </div>
                  <p className="text-lg font-semibold text-gray-900">₫2.450.000</p>
                  <p className="text-sm text-gray-600">15 giao dịch</p>
                </div>

                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <h4 className="text-sm font-medium text-gray-600">Tổng doanh số tuần</h4>
                    <Info className="h-4 w-4 text-gray-400" />
                  </div>
                  <p className="text-lg font-semibold text-gray-900">₫19.617.900</p>
                  <p className="text-sm text-green-600">+10.05% so với tuần trước</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600">+0.43% so với tuần trước</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 pt-6 border-t border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-600">Doanh số tuần này</p>
